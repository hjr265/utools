...
impl Tool for URLEncoderTool {
    ...
    fn description() -> &'static str {
        "Converts text into a URL percent-encoded string."
    }
...
impl Focusable for URLEncoderTool {
    fn focus_handle(&self, _: &gpui::App) -> gpui::FocusHandle {
        self.focus_handle.clone()
    }
}

impl Render for URLEncoderTool {
    fn render(
        &mut self,
        _: &mut gpui::Window,
